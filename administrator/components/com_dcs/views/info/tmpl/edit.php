	...
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			...
			<ul class="adminformlist">
				...
				<li><?php echo $this->form->getLabel('gmap_intergrate'); ?>
				<?php echo $this->form->getInput('gmap_intergrate'); ?></li>
				
				<li><?php echo $this->form->getLabel('gmap_override_url'); ?>
				<?php echo $this->form->getInput('gmap_override_url'); ?></li>
