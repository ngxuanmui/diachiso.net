 ...
 * @since		1.6
 */
class DcsModelProducts extends JModelList
{
	/**
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				...
				'a.checked_out AS checked_out, a.code, a.code_msg, a.email, a.hits,'.
				'a.checked_out_time AS checked_out_time, a.catid AS catid, a.sticky,' .
				'a.state AS state, a.ordering AS ordering, a.publish_up, a.publish_down,'.
				'a.language'
			)
		);
		$query->from('`#__dcs_addresses` AS a');
		...
		$query->join('LEFT', '#__dcs_info AS l ON l.id = a.location');
	...
	protected function populateState()
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_dcs');
