<?php
/**
 * @version		$Id: Brand.php 20196 2011-01-09 02:40:25Z ian $
 ...
 * @since		1.5
 */
class JE_ProductTableBrand extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__je_brands', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('Brand', 'JE_ProductTable');
	...
	public function publish($pks = null, $state = 1, $userId = 0)
	{
		...
		$table = JTable::getInstance('Brand','JE_ProductTable');
